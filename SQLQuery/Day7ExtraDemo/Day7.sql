...
go
GO
Alter Proc sp_ShowOrder   @x int  
as 
  begin 
      Select * from Orders where EmployeeID = @x
  end 

GO

Execute sp_ShowOrder 2

Drop proc sp_ShowOrder
...
Execute Sp_helptext 'sp_ShowEmployees'
...
declare @sql nvarchar(50) = ' Select * from Employees'
...
declare @Columns nvarchar(200) = 'EmployeeId , Orderdate,OrderId ';
declare @Condition nvarchar(100) = 'OrderId = 10258';
